...
confusion_matrix = table(news_test, yhat_test1)
confusion_matrix
colMeans(rmsevals)
...
I1 <- SaratogaHouses$bedrooms*SaratogaHouses$bathrooms


SH <- data.frame(cbind(SaratogaHouses, I1))
n = nrow(SH)
...
x_train = select(SH_train, c(-fireplaces, -sewer, -landValue))
y_train = select(SH_train, price)

x_test = select(SH_test, c(-fireplaces, -sewer, -landValue))
